    ...
    <MainLayout>
        ...
        <section class="metrics-grid">
            ...
            <div class="metric-card highlight">
                ...
                <h2 class="amount">Rp 13.200.000</h2>
                <span class="subtext">Across all goals</span>
            </div>
            <div class="metric-card">
        ...
        <!-- 2. Baris Konten Tengah (Goals & Breakdown) -->
        <section class="content-grid">
            <!-- Kiri: Savings Goals -->
            <div class="card goals-section">
                <div class="card-header">
                    <h3>Savings Goals</h3>
                    <button class="add-btn">+ Add Goal</button>
                </div>

                <div class="goal-item">
                    <div class="goal-info">
                        <span class="goal-name">Emergency Fund</span>
                        <span class="goal-amount">Rp 8.400.000 / Rp 12.000.000</span>
                    </div>
                    <div class="progress-bar">
                        <div class="fill green" style="width: 70%"></div>
                    </div>
                    <div class="goal-footer">
                        <span>70% reached</span>
                        <span>Rp 3.600.000 remaining</span>
                    </div>
                </div>

                <div class="goal-item">
                    <div class="goal-info">
                        <span class="goal-name">Laptop Baru</span>
                        <span class="goal-amount">Rp 3.200.000 / Rp 5.000.000</span>
                    </div>
                    <div class="progress-bar">
                        <div class="fill purple" style="width: 64%"></div>
                    </div>
                    <div class="goal-footer">
                        <span>64% reached</span>
                        <span>Rp 1.800.000 remaining</span>
                    </div>
                </div>

                <div class="goal-item">
                    <div class="goal-info">
                        <span class="goal-name">Liburan Bali</span>
                        <span class="goal-amount">Rp 1.600.000 / Rp 8.000.000</span>
                    </div>
                    <div class="progress-bar">
                        <div class="fill orange" style="width: 20%"></div>
                    </div>
                    <div class="goal-footer">
                        <span>20% reached</span>
                        <span>Rp 6.400.000 remaining</span>
                    </div>
                </div>
            </div>
